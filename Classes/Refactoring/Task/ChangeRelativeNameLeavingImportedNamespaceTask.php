 ...
 */
class ChangeRelativeNameLeavingImportedNamespaceTask extends AbstractSubObjectiveTask {
			...
			if (NULL !== $alias) {
				...
				if ($aliasName->getParts() != $otherImportedNamespaceName) {
					...
					$this->subObjectives = array(
						new \TYPO3\Zubrovka\Refactoring\Objective\NameLeavesImportedNamespaceObjective($relativeName, $newName)
					);
					return -50;
				}
			}
